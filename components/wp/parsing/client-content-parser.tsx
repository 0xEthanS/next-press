...
export const ClientContentParser = (
	...
	const parsedContent = useMemo(() => {
		...
		try {
			...
			// Set loading to false after parsing attempt
			setIsLoading(false);
		}
	}, [content, options]); // Only re-parse when content or options change

	// Handle initial loading state
	useEffect(() => {
		if (content) {
			// Use a small timeout to prevent flickering on fast parses
...
// Separate the InlinePortrait component for clarity
